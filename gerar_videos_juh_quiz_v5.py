...
def desenhar_alternativas(draw, pergunta, estado, alt_top):
    ...
    # Ajustes solicitados:
    # - círculo rosa mais para dentro da barra
    # - texto da opção maior e mais em destaque
    bar_h = 118
    gap = 24
    bar_x = 118
    bar_w = 900
    ...
    circle_d = 116
    circle_x = 82  # mais para dentro da barra branca
    ...
    for i, alt in enumerate(alternativas):
        ...
        draw_text_in_box(
            draw,
            alt,
            [bar_x + 125, y + 6, bar_x + bar_w - 25, y + bar_h - 6],
            max_size=58,
            min_size=30,
            fill=text_fill,
            bold=True,
